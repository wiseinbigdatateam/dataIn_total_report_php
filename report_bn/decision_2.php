                            ...
                            <div class="mf_all">
                                <div class="mindmap tabb1" id="select_type_x_g">
                                    ...
                                    for($opt_i=0; $opt_i<$query_file_1_cnt; $opt_i++){ // 모델명 루프 시작 
                                        ...
                                        $sql_file_2 = "select idx from wise_analysis_report_decision_option_model_quiz where 1 and decision_option_idx='".$decision_option_idx."' and decision_option_model_idx='".$row_file_1['idx']."' and (decision_option_model_quiz_parent = '' or decision_option_model_quiz_parent is null) order by idx asc";
                                    ...
                                    <div class="node node_root">
										...
										<?if($query_file_2_cnt > 0){ // 하위 카운트 있을때 시작 ?>
											<div class="dec_add dec_add1" style="display:none;">
                                                <button type="button"><img src="./img/plus_sq.png" alt="" onclick="go_tmp_child('P','add','K');"></button>
                                            </div>
                                            <div class="dec_min dec_min1 tabb2" style="display:block;">
                                                <button type="button"><img src="./img/minus_sq.png" alt="" onclick="go_tmp_child('P','minus','K');"></button>
                                            </div>
                                        <?}else{?>
								    ...
								    <?if($query_file_2_cnt > 0){ // 하위 카운트 있을때 시작 ?>
									<ol class="children" id="decision2_area_<?=$row_file_1['idx']?>">
