...
<?
	...
	$query = "select * from wise_analysis_myreport where 1 and idx='".$idx."'";
	...
	$del_1_sql = "delete from wise_analysis_option where 1 and report_type='".$row['report_type']."' and report_idx='".$row['report_idx']."'";
	$del_1_result = mysqli_query($gconnet,$del_1_sql);

	$del_2_sql = "delete from wise_analysis_myreport where 1 and idx='".$row['idx']."'";
