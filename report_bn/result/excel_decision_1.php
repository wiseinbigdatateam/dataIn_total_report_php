	...
	<head>
		...
		?>
			<tr bgcolor=#ffffff align="center" height="22">
				...
				<?if($ilk_option_case_no){
					$il_sql_file_2 = "select analysis_report_decision_100data_ilk_yn from wise_analysis_report_decision_100data_detail where 1 and decision_option_idx='".$decision_option_idx."' and analysis_report_decision_100data_no='".$row_file_2['data_no']."' and analysis_report_decision_100data_ilk_yn is not null";
				...
				?>	
					...
					<?=get_decision_100data_no_val($decision_option_idx,$data_no,"","","",$file_1_title2)?>
					</td>
				<?}?>
			</tr>
		<?}?>
