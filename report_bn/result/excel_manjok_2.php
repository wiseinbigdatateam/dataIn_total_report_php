...
<?
	...
	//echo "sql_file_2 = ".$sql_file_2."<br>"; exit;
	...
	<head>
		...
		?>
			<tr bgcolor=#ffffff align="center" height="22">
				...
				?>	
					<td style="mso-number-format:'\@'"><?=iconv("UTF-8","EUC-KR",get_satisfaction_data_group_detail($satisfaction_option_idx,$row_file_2['satisfaction_data_group_idx'],$row_file_2['analysis_report_satisfaction_data_group2_no'],$file_1_idx2,$file_1_title2))?></td>
				<?}?>
			</tr>
		<?
