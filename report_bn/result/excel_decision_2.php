...
<?
	...
	$sql_file_1 = "select analysis_report_decision_100data_no from wise_analysis_report_decision_100data_detail2 where 1 and decision_option_idx='".$decision_option_idx."' order by analysis_report_decision_100data_no asc limit 0,1"; 
	$query_file_1 = mysqli_query($gconnet,$sql_file_1);
	$row_file_1 = mysqli_fetch_array($query_file_1);

	$sql_file_1 = "select analysis_report_decision_100data_quiz_no as quiz_no,analysis_report_decision_100data_quiz_title as quiz_title from wise_analysis_report_decision_100data_detail2 where 1 and decision_option_idx='".$decision_option_idx."' and analysis_report_decision_100data_no='".$row_file_1['analysis_report_decision_100data_no']."' order by idx asc";
	$query_file_1 = mysqli_query($gconnet,$sql_file_1);
	...
	<head>
		...
		?>
			<tr bgcolor=#ffffff align="center" height="22">
				...
				<?if($ilk_option_case_no){
					$il_sql_file_2 = "select analysis_report_decision_100data_ilk_yn from wise_analysis_report_decision_100data_detail2 where 1 and decision_option_idx='".$decision_option_idx."' and analysis_report_decision_100data_no='".$row_file_2['data_no']."' and analysis_report_decision_100data_ilk_yn is not null";
				...
				?>	
					...
					<?=get_decision_100data2_no_val($decision_option_idx,$data_no,"","","",$file_1_title2)?>
					</td>
				<?}?>
			</tr>
		<?}?>
