...
?>
	...
	<table width="100%">
		...
		<?}?>
			<td bgcolor=#CCCCCC><font color="#669900"><strong>총점</strong></font></td>
	<?if($query_file_2_cnt > 0){?>	
		<?
			for($opt_i=0; $opt_i<sizeof($file_2_title_arr); $opt_i++){
				$file_2_title2 = trim($file_2_title_arr[$opt_i]);
		?>
			<td bgcolor=#CCCCCC><font color="#669900"><strong>순위</strong></font></td>
		<?}?>
	<?}?>
		</tr>
		...
		?>
				...
				?>
						...
						<?if($row_file_4['analysis_report_damyun_data_quiz_no'] == $file_2_quizno){?>
							...
							<?=$row_file_4['analysis_report_damyun_data_quiz_title']?>
						<?}?>
						</td>
				<?} // 집단문항루프 종료 ?>
