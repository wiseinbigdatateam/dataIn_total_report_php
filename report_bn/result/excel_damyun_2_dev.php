...
<?
	...
	echo "file_1_title = ".$file_1_title."<br>"; //exit;
	...
	<head>
		...
		?>
			<tr bgcolor=#ffffff align="center" height="22">
				...
				?>	
					<td style="mso-number-format:'\@'"><?//=iconv("UTF-8","EUC-KR",get_damyun_100data_no_val($damyun_option_idx,$data_no,$file_1_idx2,$file_1_group2,$file_1_title2))?>
					<?=get_damyun_100data_no_val($damyun_option_idx,$data_no,$file_1_idx2,$file_1_group2,$file_1_title2)?>
					</td>
				<?}?>
