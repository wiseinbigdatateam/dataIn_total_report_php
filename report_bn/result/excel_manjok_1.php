	...
	<head>
		...
		?>
			<tr bgcolor=#ffffff align="center" height="22">
				...
				?>	
					<td style="mso-number-format:'\@'"><?=iconv("UTF-8","EUC-KR",get_satisfaction_100data_no_val_16($satisfaction_option_idx,$data_no,$file_1_idx2,$file_2_idx2,$file_1_title2))?></td>
				<?}?>
			</tr>
		<?}?>
		</table>
