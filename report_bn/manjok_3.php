...
<?
	...
	if($row['analysis_report_satisfaction_option_percent']){
		$satisfaction_option_percent = $row['analysis_report_satisfaction_option_percent'];	
	} else {
		$satisfaction_option_percent = "1";
	}
    ...
    <section>
        <div class="body_w">
         <form name="frm" action="manjok_3_action.php" target="_fra_admin" method="post"  enctype="multipart/form-data">
			...
			<input type="hidden" id="satisfaction_option_loyer_stf" name="satisfaction_option_loyer_stf">
			<input type="hidden" id="satisfaction_option_loyer_lyt" name="satisfaction_option_loyer_lyt">
			<div class="side_men">
                        ...
                        <div class="mop_l1 tabb1">
                            ...
                            <div class="mop_l2 tabb2">
                                ...
                                <div class="mop_sosu">
                                    <div class="sosu_1">
                                        <span>점수의 소수점</span>
                                        <input type="number" placeholder="1" name="satisfaction_option_scorepoint" id="satisfaction_option_scorepoint" required="no" message="점수의 소수점" value="<?=$row['analysis_report_satisfaction_option_scorepoint']?>">
                                        <span>째 자리</span>
                                    </div>
                                    <div class="sosu_2">
                                        <span>빈도의 소수점</span>
                                        <input type="number" placeholder="1" name="satisfaction_option_scorepoint2" id="satisfaction_option_scorepoint2" required="no" message="빈도의 소수점" value="<?=$row['analysis_report_satisfaction_option_scorepoint2']?>">
                                        <span>째 자리</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mop_l4 tabb4">
                                <div class="title">
                                    <p>충성고객 유형분석<!-- / <?=$satisfaction_option_loyer?>--></p>
                                </div>
                                <div class="mop_cus ">
                                    <div class="cus_1">
                                        <div class="cus_ok">
                                        ...
                                        <div class="cus_no">
                                            <label for="c_no">
                                                <input value="none" type="radio" id="c_no" name="satisfaction_option_loyer" value="N" <?=$satisfaction_option_loyer=="N"?"checked":""?>>
                                                <span>비반영</span>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="cus_que" <?if($satisfaction_option_loyer=="Y"){?>style="display:block;"<?}?>>
                                        <div class="cus_box1">
											<div class="cb_box" id="satisfaction_manjok_area">
                                                <button class="cb_bt1" type="button"><img src="./img/plus_sq.png" alt=""></button>
                                                <span>만족도 추가</span>
											<?if($row['analysis_report_satisfaction_option_loyer_stfno']){?>
												<li id="ql_<?=$row['analysis_report_satisfaction_option_loyer_stfno']?>" class="ui-widget-content item_serv ui-selectee ui-selected selected-flag"><span class="close ui-selectee" style=""><button class="ui-selectee"><img src="./img/remove.png" alt="" class="ui-selectee"></button></span><a href="javascript:<?=$row['analysis_report_satisfaction_option_loyer_stfno']?>;" class="ui-selectee" title="<?=$row['analysis_report_satisfaction_option_loyer_stftitle']?>"><?=$row['analysis_report_satisfaction_option_loyer_stftitle']?></a></li>
											<?}?>
											</div>
                                        </div>
                                        <div class="cus_arrow"><img src="./img/toge_arrow.png" alt=""></div>
                                        <div class="cus_box2" >
											<div class="cb_box" id="satisfaction_chung_area">
                                                <button class="cb_bt2" type="button"><img src="./img/plus_sq.png" alt=""></button>
                                                <span>충성도 추가</span>
											<?if($row['analysis_report_satisfaction_option_loyer_lytno']){?>
												<li id="ql_<?=$row['analysis_report_satisfaction_option_loyer_lytno']?>" class="ui-widget-content item_serv ui-selectee ui-selected selected-flag"><span class="close ui-selectee" style=""><button class="ui-selectee"><img src="./img/remove.png" alt="" class="ui-selectee"></button></span><a href="javascript:<?=$row['analysis_report_satisfaction_option_loyer_lytno']?>;" class="ui-selectee" title="<?=$row['analysis_report_satisfaction_option_loyer_lyttitle']?>"><?=$row['analysis_report_satisfaction_option_loyer_lyttitle']?></a></li>
											<?}?>
                                            </div>
                                        </div>
                                    </div>
...
satisfaction_option_loyer_stf
satisfaction_option_loyer_lyt
	...
	function go_submit() {
		...
		$("#satisfaction_option_loyer_stf").val($("#satisfaction_manjok_area").html());
		$("#satisfaction_option_loyer_lyt").val($("#satisfaction_chung_area").html());
