...
function get_ipa_x_val($satisfaction_option_idx,$analysis_report_idx){
	...
	if(!$search_prev_1){ // 독립변수 없음 
		...
		//echo "get_ipa_x_val sql_file_1 = ".$sql_file_1."<br>";
...
function get_ipa_y_val($satisfaction_option_idx,$analysis_report_idx){
	...
	if(!$search_prev_1){ // 종속변수 없음 
		...
		//echo "get_ipa_y_val sql_file_1 = ".$sql_file_1."<br>";
...
function get_option_url($rtype,$ridx){
	switch ($rtype) {
		case "manjok" : 
		$rtype_name = "/report/manjok_1.php?satisfaction_option_idx=".$ridx."&chapter=new";
		break;
		case "service" : 
		$rtype_name = "/report/service_1.php?service_option_idx=".$ridx."&chapter=new";
		break;
		case "damyun" : 
		$rtype_name = "/report/damyun_1.php?damyun_option_idx=".$ridx."&chapter=new";
		break;
		case "decision" : 
		$rtype_name = "/report/decision_1.php?decision_option_idx=".$ridx."&chapter=new";
		break;
	}
	return $rtype_name;
}
...
function get_calcurate_decision_avg($data_100_model_no,$decision_option_idx,$file_1_title2,$type){
	$memid = $_SESSION['wiz_session']['id'];
	$subid = $_SESSION['wiz_session']['subid'];
...
function get_calcurate_decision_excel_avg($data_100_model_no,$decision_option_idx,$file_1_title2,$type,$an_idx,$quiz_no,$answ){
	$compet_info_sql = "select analysis_report_decision_option_scorepoint from wise_analysis_report_decision_option where 1 and idx='".$decision_option_idx."'";
	$compet_info_query = mysqli_query($GLOBALS['gconnet'],$compet_info_sql);
	$row = mysqli_fetch_array($compet_info_query);
	$decision_option_scorepoint = $row['analysis_report_decision_option_scorepoint'];
