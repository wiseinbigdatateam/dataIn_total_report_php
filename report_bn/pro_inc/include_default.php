...
include $_SERVER["DOCUMENT_ROOT"]."/report_bn/pro_inc/db_conn.php";
include $_SERVER["DOCUMENT_ROOT"]."/report_bn/pro_inc/user_function.php"; // PHP 유저 함수 모음
...
// 첨부파일 저장
$_P_DIR_FILE =  $_SERVER["DOCUMENT_ROOT"]."/report_bn/upload_file/"; //게시판,자료 등에서 업로드하는 폴더가 저장되는 경로
$_P_DIR_WEB_FILE= "/report_bn/upload_file/";
...
// 2022-01-20 : 로그인 확인 ----- kky
include $_SERVER["DOCUMENT_ROOT"]."/report_bn/pro_inc/check_login.php";
?>