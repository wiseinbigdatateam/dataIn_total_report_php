				...
				?>
                       <li id="ql_<?=$sub_row_1['idx']?>" class=" item_serv" >
                            <div class="node">
                                ...
                                <div class="score_div">
                                    <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="inc_left_quiz_score2_<?=$sub_row_1['idx']?>" id="inc_left_quiz_score2_<?=$sub_row_1['idx']?>" class="left_input_score2" onblur="set_calc_quiz_score2();">
                                </div>
                                <span class="jong_div">
                                    <input type="checkbox" name="inc_left_quiz_tscyn2_<?=$sub_row_1['idx']?>" id="inc_left_quiz_tscyn2_<?=$sub_row_1['idx']?>" value="Y" checked>
									<script>$("#inc_left_quiz_tscyn2_<?=$sub_row_1['idx']?>").trigger("click");</script>
                                </span>
                                <div class="dec_bwrap">
