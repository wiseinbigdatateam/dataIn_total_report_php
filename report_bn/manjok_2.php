                                                    ...
                                                    <div class="box_mid">
                                                        <div class="bwm_l">
                                                            <div class="ym_wrap tabb3">
                                                                ...
                                                                <input type="number" class="yo_num" name="variable_x_elementweight[]" placeholder="가중치%"  onblur="calc_weight();" id="elementweight<?=($opt_i+1)?>" value="<?=$row_file_1['analysis_report_satisfaction_option_variable_elementweight']?>">
                                                            </div>
                                                        </div>
                                                        <div class="bwm_r tabb4">
                                                            <input type="number" placeholder="가중치%"  name="variable_x_weight[]" onblur="calc_weight();" id="weight<?=($opt_i+1)?>" value="<?=$row_file_1['analysis_report_satisfaction_option_variable_weight']?>">
                                                        </div>
                                                    </div>
								   ...
								   <!-- 중간변수 파트 시작 -->
                                            <div class="box_wrap center_wrap">
                                                <div class="bw_top">
                                                    ...
                                                    <input type="number" placeholder="가중치%"  name="variable_m_weight" placeholder="가중치%" onblur="calc_weight();" value="<?=$row_file_3['analysis_report_satisfaction_option_variable_weight']?>">
                                                    </div>
                                                </div>
                                            </div>
									 <!-- 중간변수 파트 종료 -->
...
$(document).ready(function(){
    ...
    function go_submit() {
        ...
        var total = document.querySelector('#tot_weight_area').innerText;
        if((total == 100) || (total == 0)) {

        } else {
            alert('가중치의 총합은 0 또는 100 이어야 합니다.');
            return false;
        }
        // 2021-07-29 추가
        // 왼쪽 변수
